...
public class hdfc implements BankAccounts{
    ...
    public void init(AccountDetails accountDetails) {
        ...
        System.out.println("HDFC rocket");
    ...
    public void balancenquery() {
        ...
        System.out.println("Operation Done on HDFC");
    }
    ...
    public void moneytransfer(BankAccounts account,double amount) throws InvalidAmount,insufficientBalanceException {
        withdraw(amount);
        deposit(amount);
        System.out.println("Operation done on HDFC Account");
    }
}
